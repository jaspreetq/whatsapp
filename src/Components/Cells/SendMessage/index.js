...
function SendMessage() {
  ...
  const handleSend = async () => {
    ...
    setMessage("");
    if ((messageLocal?.trim() === "") && (!messageLocal?.img) && (!messageLocal?.pdf)) {
      ...
      <div className="d-flex justify-content-start file-upload">
        ...
        <div>
          <label htmlFor="attachement">
            <svg xmlns="http://www.w3.org/2000/svg" width="30" height="90" fill="#73777a" class="bi bi-paperclip" viewBox="0 0 16 16">
              <path d="M4.5 3a2.5 2.5 0 0 1 5 0v9a1.5 1.5 0 0 1-3 0V5a.5.5 0 0 1 1 0v7a.5.5 0 0 0 1 0V3a1.5 1.5 0 1 0-3 0v9a2.5 2.5 0 0 0 5 0V5a.5.5 0 0 1 1 0v7a3.5 3.5 0 1 1-7 0V3z" />
            </svg>
          </label>
          <input id="attachement" style={{ display: "contents" }} type="file" onChange={handleFileChange} accept="image/*,application/pdf" />
        ...
        <div>
          <button className="send-message" onClick={(e) => handleSend(e)}>Send</button></div>
      </div>
